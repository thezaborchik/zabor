...
extension MediaQueryFix on MediaQuery {
...
Future<void> initializeApp() async {
  // Здесь может быть инициализация Firebase, API и т.д.
  await Future.delayed(Duration.zero); // Заглушка, замените на реальную логику
}
